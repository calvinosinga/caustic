...
#endif
		{
		  ...
		  if(TimeBinActive[P[i].TimeBin])
		      ...
		      if(SphP[i].d.Density > 0)
			{
			  ...
			  double dtDV[3][3], Tinv[3][3], A[3][3], V[3][3], St[3][3], S[3][3], Vt[3][3], SSt[3][3];
			  ...
			  V[0][0] = SphP[i].NV_D[0][0]*Tinv[0][0] + SphP[i].NV_D[0][1]*Tinv[1][0] + SphP[i].NV_D[0][2]*Tinv[2][0];
			  V[0][1] = SphP[i].NV_D[0][0]*Tinv[0][1] + SphP[i].NV_D[0][1]*Tinv[1][1] + SphP[i].NV_D[0][2]*Tinv[2][1];
			  V[0][2] = SphP[i].NV_D[0][0]*Tinv[0][2] + SphP[i].NV_D[0][1]*Tinv[1][2] + SphP[i].NV_D[0][2]*Tinv[2][2];
			  V[1][0] = SphP[i].NV_D[1][0]*Tinv[0][0] + SphP[i].NV_D[1][1]*Tinv[1][0] + SphP[i].NV_D[1][2]*Tinv[2][0]; 
			  V[1][1] = SphP[i].NV_D[1][0]*Tinv[0][1] + SphP[i].NV_D[1][1]*Tinv[1][1] + SphP[i].NV_D[1][2]*Tinv[2][1];
			  V[1][2] = SphP[i].NV_D[1][0]*Tinv[0][2] + SphP[i].NV_D[1][1]*Tinv[1][2] + SphP[i].NV_D[1][2]*Tinv[2][2]; 
			  V[2][0] = SphP[i].NV_D[2][0]*Tinv[0][0] + SphP[i].NV_D[2][1]*Tinv[1][0] + SphP[i].NV_D[2][2]*Tinv[2][0];
			  V[2][1] = SphP[i].NV_D[2][0]*Tinv[0][1] + SphP[i].NV_D[2][1]*Tinv[1][1] + SphP[i].NV_D[2][2]*Tinv[2][1];
			  V[2][2] = SphP[i].NV_D[2][0]*Tinv[0][2] + SphP[i].NV_D[2][1]*Tinv[1][2] + SphP[i].NV_D[2][2]*Tinv[2][2];
	
			  A[0][0] = SphP[i].NV_A[0][0]*Tinv[0][0] + SphP[i].NV_A[0][1]*Tinv[1][0] + SphP[i].NV_A[0][2]*Tinv[2][0];
			  A[0][1] = SphP[i].NV_A[0][0]*Tinv[0][1] + SphP[i].NV_A[0][1]*Tinv[1][1] + SphP[i].NV_A[0][2]*Tinv[2][1];
			  A[0][2] = SphP[i].NV_A[0][0]*Tinv[0][2] + SphP[i].NV_A[0][1]*Tinv[1][2] + SphP[i].NV_A[0][2]*Tinv[2][2];
			  A[1][0] = SphP[i].NV_A[1][0]*Tinv[0][0] + SphP[i].NV_A[1][1]*Tinv[1][0] + SphP[i].NV_A[1][2]*Tinv[2][0]; 
			  A[1][1] = SphP[i].NV_A[1][0]*Tinv[0][1] + SphP[i].NV_A[1][1]*Tinv[1][1] + SphP[i].NV_A[1][2]*Tinv[2][1];
			  A[1][2] = SphP[i].NV_A[1][0]*Tinv[0][2] + SphP[i].NV_A[1][1]*Tinv[1][2] + SphP[i].NV_A[1][2]*Tinv[2][2]; 
			  A[2][0] = SphP[i].NV_A[2][0]*Tinv[0][0] + SphP[i].NV_A[2][1]*Tinv[1][0] + SphP[i].NV_A[2][2]*Tinv[2][0];
			  A[2][1] = SphP[i].NV_A[2][0]*Tinv[0][1] + SphP[i].NV_A[2][1]*Tinv[1][1] + SphP[i].NV_A[2][2]*Tinv[2][1];
			  A[2][2] = SphP[i].NV_A[2][0]*Tinv[0][2] + SphP[i].NV_A[2][1]*Tinv[1][2] + SphP[i].NV_A[2][2]*Tinv[2][2];
			  ...
			  double Shock_Scalar1 = SphP[i].Shock_N1[0]*Shock_W2[0] + SphP[i].Shock_N1[1]*Shock_W2[1] + SphP[i].Shock_N1[2]*Shock_W2[2];
			  ...
			  SphP[i].Shock_N3[0] = SphP[i].Shock_N1[1]*SphP[i].Shock_N2[2] - SphP[i].Shock_N1[2]*SphP[i].Shock_N2[1];
			  SphP[i].Shock_N3[1] = SphP[i].Shock_N1[2]*SphP[i].Shock_N2[0] - SphP[i].Shock_N1[0]*SphP[i].Shock_N2[2];
			  SphP[i].Shock_N3[2] = SphP[i].Shock_N1[0]*SphP[i].Shock_N2[1] - SphP[i].Shock_N1[1]*SphP[i].Shock_N2[0];
			  double Shock_Abs3 = 1.0/sqrt(SphP[i].Shock_N3[0]*SphP[i].Shock_N3[0] + 
...
#endif
#ifdef FS_ALFA2_TURB
			double rr[3],final_mom=0.0,norm=0.0; final_mom=0.0;	norm=0.0;
			for(k=0;k<3;k++)
			...
			norm = sqrt(norm);
			if(norm != 0 && P[i].TimeBin )
			{
				SphP[i].alfa2 = final_mom/norm * SphP[i].d.Density * 1E4 ; // ( 10. * SphP[i].Ne);
#ifndef FS_ALFA2_QUENCH
				if(abs(SphP[i].alfa2) > 1.0) 
					SphP[i].alfa2 /= abs(SphP[i].alfa2); // artificial quenching
#endif
			}
#endif
#ifdef FS_ALFA2_QUENCH
		if((SysState.MaxAlfa2 > 0) && (Flag_FullStep == 1))
			   SphP[i].alfa2 *= All.Alfa0Quench / SysState.MaxAlfa2 / (SysState.EnergyMag/All.AlfaB2eq + 1.);
#endif
#ifdef FS_ALFA2_LOCAL_QUENCH
		if(SphP[i].Alfa2 != 0)
			   SphP[i].alfa2 *= All.Alfa0Quench / 
( (SphP[i].b2.BPred[0]*SphP[i].b2.BPred[0] + SphP[i].b2.BPred[1]*SphP[i].b2.BPred[1] +SphP[i].b2.BPred[2] * SphP[i].b2.BPred[2] )
			/All.AlfaB2eq + 1.);
#endif
#ifdef FS_ETA2_TURB
		        if(P[i].TimeBin)
#ifdef FS_ETA2_TURB_KIN			
			SphP[i].eta2 = 1./3. * PPP[i].Hsml * PPP[i].Hsml * SphP[i].r.CurlVel;
#else
			SphP[i].eta2 = 1. / (SphP[i].d.Density * 1E4 );
			SphP[i].eta2 = 5. *pow(10., -pow(SphP[i].d.Density,0.1 )); 
			if(SphP[i].eta2 <  1.0 ) SphP[i].eta2 =  1.0 ; 
			if(SphP[i].eta2 > 10.0 ) SphP[i].eta2 = 10.0 ; 
#endif
#endif
#ifdef JD_VTURB
      ...
      while(startnode >= 0)
	{
	  ...
	  numngb_inbox =
	    cs_ngb_treefind_variable_decoupling_threads(&local.Pos[0], local.Hsml, target, &startnode,
							densityold, entropy, &local.Vel[0], mode, exportflag,
...
#ifdef VISCOSITY_SUPPRESSION
      out->NV_A[0][0] += (local->Accel[0] - P[j].g.GravAccel[0] - SphP[j].a.HydroAccel[0]) * kernel->dx * kernel->mj_dwk_r;
      out->NV_A[0][1] += (local->Accel[0] - P[j].g.GravAccel[0] - SphP[j].a.HydroAccel[0]) * kernel->dy * kernel->mj_dwk_r;
      out->NV_A[0][2] += (local->Accel[0] - P[j].g.GravAccel[0] - SphP[j].a.HydroAccel[0]) * kernel->dz * kernel->mj_dwk_r;
      out->NV_A[1][0] += (local->Accel[1] - P[j].g.GravAccel[1] - SphP[j].a.HydroAccel[1]) * kernel->dx * kernel->mj_dwk_r;
      out->NV_A[1][1] += (local->Accel[1] - P[j].g.GravAccel[1] - SphP[j].a.HydroAccel[1]) * kernel->dy * kernel->mj_dwk_r;
      out->NV_A[1][2] += (local->Accel[1] - P[j].g.GravAccel[1] - SphP[j].a.HydroAccel[1]) * kernel->dz * kernel->mj_dwk_r;
      out->NV_A[2][0] += (local->Accel[2] - P[j].g.GravAccel[2] - SphP[j].a.HydroAccel[2]) * kernel->dx * kernel->mj_dwk_r;
      out->NV_A[2][1] += (local->Accel[2] - P[j].g.GravAccel[2] - SphP[j].a.HydroAccel[2]) * kernel->dy * kernel->mj_dwk_r;
      out->NV_A[2][2] += (local->Accel[2] - P[j].g.GravAccel[2] - SphP[j].a.HydroAccel[2]) * kernel->dz * kernel->mj_dwk_r;
