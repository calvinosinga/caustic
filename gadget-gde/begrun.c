...
#pragma omp master
  ...
  if(RestartFlag == 0 || RestartFlag == 2 || RestartFlag == 3 || RestartFlag == 4 || RestartFlag == 5 || RestartFlag == 6)
  ...
  else
    {
      ...
      double gauss2gadget =sqrt(All.UnitTime_in_s * All.UnitTime_in_s * All.UnitLength_in_cm / All.UnitMass_in_g);
...
#ifdef AB_SHOCK
      strcpy(tag[nt], "ShockfinderNoiselevel");
      addr[nt] = &All.ShockfinderNoiselevel;
      id[nt++] = REAL;
#endif
