...
#if (defined(SMOOTH_DIVB)  || defined(SMOOTH_ROTB) || defined(BSMOOTH) || (defined(LT_STELLAREVOLUTION) && !defined(LT_DONTUSE_DENSITY_in_WEIGHT)) || defined(LT_SMOOTH_Z) || defined(LT_SMOOTH_XCLD) || defined(LT_TRACK_WINDS) )
      smoothed_values();
#endif
