...
double LT_AbundanceRatios(double temp, double rho, double *ne_guess);
double DoCooling(double u_old, double rho, double *Metallicities, double Redshift, double DZ, double dt, double *temp);
