...
#define CPU_PARTS          46  /* this gives the number of parts above (must be last) */
...
extern ALIGN(32) struct particle_data
{
  ...
  MyFloat tidal_tensorps[3][3];                     /*!< tidal tensor (=second derivatives of grav. potential) */
  MyFloat V_matrix[3][3];                     	    /*!< initial orientation of CDM sheet the particle is embedded in */
  MyFloat init_density;                             /*!< initial stream density */
...
#endif
#ifdef PMGRID
  MyFloat tidal_tensorpsPM[3][3];	            /*!< for TreePM simulations, long range tidal field */
#endif
#endif
...
#endif
#if (defined(SMOOTH_DIVB) || defined(DIVBCLEANING_DEDNER) || defined(BSMOOTH) || defined(SMOOTH_ROTB) || ((defined(LT_STELLAREVOLUTION) && !defined(LT_DONTUSE_DENSITY_in_WEIGHT)) || defined(LT_SMOOTH_Z) || defined(LT_SMOOTH_XCLD) || defined(LT_TRACK_WINDS)))
  MyFloat DensityNorm;
#endif
